...
const messages = {
    ...
    ar: 'مرحباً، أنا مهتم بـ DZ-Ghost. هل يمكنكم مساعدتي؟',
};
                    ...
                    <AnimatePresence>
                        {showTooltip && (
                            <motion.div
                                ...
                                className="bg-slate-900 text-white text-xs font-medium px-3 py-2 rounded-lg shadow-lg max-w-[180px] text-center leading-relaxed"
                            >
                                {lang === 'ar' ? 'تحدث معنا على واتساب' : 'Discutez avec nous sur WhatsApp'}
